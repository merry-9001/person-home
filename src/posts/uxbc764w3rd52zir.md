---
title: 移动端
urlname: uxbc764w3rd52zir
date: 2024-11-05 12:11:21 +0800
tags: []
description: 常见问题最后，我们总结一些移动端经常容易被问到的问题。1. 300ms 延迟问题300ms 延迟问题产生原因？早在 2007
  年初，苹果公司在发布首款 iPhone 前夕，遇到一个问题：当时的网站都是为大屏幕设备所设计的。于是苹果的工程师们做了一些约定，应对 iPhone
  这种小屏幕浏览桌面端...
image: ''
categories: []
---
...
<meta
  name="viewport"
  content="user-scalable=no,initial-scale=1,maximun-scale=1"
/>
```
...
### 4. 移动端 _APP_ 有哪些类型，区别是什么？

> 移动端应用细分为三大类：_WebApp_、_NativeApp_ 和 _HybridApp_  
...
> 9. 小程序发布
>
> 参考链接：[https://www.cnblogs.com/ssrstm/p/6855572.html](https://www.cnblogs.com/ssrstm/p/6855572.html)
...
<template>
  <view>
    <web-view
      :src="webviewUrl"
      @message="handleMessageFromWebView"
      ref="webviewRef"
    ></web-view>
  </view>
</template>
  ...
  export default {
    ...
    methods: {
      sendMessageToWebView() {
        ...
        if (webview) {
          webview.postMessage("message from uni-app");
        }
      },
    },
  };
...
>
> 参考链接：[https://www.cnblogs.com/unclekeith/p/7129093.html](https://www.cnblogs.com/unclekeith/p/7129093.html)
...
> 视频讲解
>
> 参考链接：[https://www.cnblogs.com/superlizhao/p/8729190.html](https://www.cnblogs.com/superlizhao/p/8729190.html)
